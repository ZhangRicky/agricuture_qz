...
@Entity
@JsonAutoDetect
@JsonIgnoreProperties(value={"farmers"})
public class FarmerImport implements Serializable{
...
//	@ManyToOne
	...
	@OneToMany(cascade=CascadeType.ALL, mappedBy="farmerImport",fetch=FetchType.LAZY)
