...
<body>
	<div id='subNav'>
		...
		<i class="glyphicon glyphicon-menu-right"></i>用户管理
	</div>
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<script type="text/x-kendo-template" id="template">
	                <div class="toolbar" >
	                	<!--<a id='addUser' class='btn btn-xs btn-success'><i class='glyphicon glyphicon-plus-sign'></i> 添加用户</a>-->
	                	<shiro:hasPermission name="addUserInfo"><a id='addUser' class='btn btn-xs btn-success'><i class='glyphicon glyphicon-plus-sign'></i>添加用户<a/>&nbsp;&nbsp;</shiro:hasPermission>
					</div>
	            </script>
	...
	<myScript>
		<script type="text/javascript" src="resources/js/SystemManage/userManage.js" ></script>
	</myScript>
